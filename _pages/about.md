...
title: about
permalink: /
subtitle: <strong>PhD Candidate &middot; Systems Researcher</strong> &middot; <a href='https://www.ece.iastate.edu/'>Electrical &amp; Computer Engineering</a>, <a href='https://www.iastate.edu/'>Iowa State University</a> &middot; <em>Open RAN &middot; 5G/6G &middot; Wireless Living Labs &middot; URLLC</em>
...
profile:
  ...
  more_info: >
    <p><i class="fa-solid fa-location-dot"></i> 306 Durham Center</p>
    ...
    <p><i class="fa-solid fa-user-graduate"></i> Advisor: <a href='https://web.ece.iastate.edu/hongwei/'>Prof. Hongwei Zhang</a></p>
...
I am a PhD candidate in Computer Engineering at **Iowa State University**, advised by [Prof. Hongwei Zhang](https://web.ece.iastate.edu/hongwei/) in the [WiCI Center](https://wici.iastate.edu/). I build **open, programmable, and reliable next-generation wireless systems** — and the **living-lab infrastructure** needed to evaluate them under the messy conditions of the real world.

My research sits at the intersection of **wireless systems, networked infrastructure, and software engineering**. I lead the design and deployment of the [**ARA Wireless Living Lab**](https://arawireless.org/) — a large-scale, fully programmable 5G/Open-RAN testbed serving over **170 researchers** across the U.S. — and I build systems on top of it: [**AraSDR**](https://ieeexplore.ieee.org/document/10623061) (end-to-end 5G prototyping), [**AraRACH**](https://arxiv.org/abs/2503.18218) (reliable random access — *Best Paper, IEEE NetSoft 2025*), and **FlexRU** (a virtualization framework for shared radio units). In 2024 I spent a semester at **Microsoft Research** building a GEO-based 5G non-terrestrial network testbed.

I am on the **academic job market for Fall 2026**. My long-term vision is to *democratize next-generation wireless innovation* — making 5G/6G accessible, affordable, and deployable for rural, agricultural, and underserved communities, beginning in Iowa and the broader Midwest.
...
<p style="font-size: 0.85rem; opacity: 0.7; text-align: center; margin-top: 0.5rem;">
  ...
  &nbsp;&middot;&nbsp;
  <i class="fa-brands fa-linkedin"></i>&nbsp; <a href="https://www.linkedin.com/in/joshua-ofori-boateng/">LinkedIn</a>
</p>
