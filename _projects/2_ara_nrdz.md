...
- <i class="fa-solid fa-globe"></i> **Project page:** [ARA-NRDZ at WiCI](https://wici.iastate.edu/ara-nrdz/)
- <i class="fa-solid fa-building-columns"></i> **Program:** NSF National Radio Dynamic Zones (NRDZ)
- <i class="fa-solid fa-tower-cell"></i> **Built on:** [ARA Wireless Living Lab](https://arawireless.org/)
